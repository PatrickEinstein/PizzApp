...
export function calculateDoughIngredients(
  ...
  const saltWeight = flourWeight * saltRatio;
  const yeastWeight = flourWeight * CY;
  ...
  //   const YeasMass = ((+YeastNeeded)/(+Sigma))*100
  ...
  const maindoughdose = remains + waterWeight + yeastWeight + saltWeight;
